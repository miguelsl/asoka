...
class CurrentUser
{
	 ...
	 */
	static public function init($usuario){
...
*/
		...
		if(isset(CurrentUser::$account)){
			CurrentUser::$admin = in_array("admin",CurrentUser::$account->groups);
		}
	}

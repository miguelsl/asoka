<?php /* Smarty version 2.6.14, created on 2013-11-13 08:22:23
         compiled from patrones/P2M2FIL-EDIM1LIS-EDI/actionDetalle.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'patrones/P2M2FIL-EDIM1LIS-EDI/actionDetalle.tpl', 35, false),array('modifier', 'explode', 'patrones/P2M2FIL-EDIM1LIS-EDI/actionDetalle.tpl', 202, false),)), $this); ?>
<?php echo '<?php'; ?>
...
$this->_sections['select']['last']       = ($this->_sections['select']['iteration'] == $this->_sections['select']['total']);
 echo $this->_tpl_vars['fields_detalle'][$this->_sections['select']['index']]; ?>
 as \"<?php if ($this->_tpl_vars['foreignKey_detalle'][$this->_sections['select']['index']] == 'true'):  echo $this->_tpl_vars['fields_detalle'][$this->_sections['select']['index']];  else: ?>edi_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['select']['index']];  endif; ?>\"<?php if ($this->_sections['select']['last']):  else: ?>, <?php endif;  endfor; endif; ?> FROM <?php echo $this->_tpl_vars['tablename_detalle']; ?>
";
...
");
		$this->addMatching("<?php if ($this->_tpl_vars['foreignKey_detalle'][$this->_sections['lis']['index']] == 'true'):  echo $this->_tpl_vars['fields_detalle'][$this->_sections['lis']['index']];  else: ?>edi_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['lis']['index']];  endif; ?>", "<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['lis']['index']]; ?>
", "<?php echo $this->_tpl_vars['tablename_detalle']; ?>
");
<?php endfor; endif; ?>

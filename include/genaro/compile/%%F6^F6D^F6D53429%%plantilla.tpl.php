<?php /* Smarty version 2.6.14, created on 2013-11-19 10:12:26
         compiled from patrones/P2M2FIL-EDIM1EDI/plantilla.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'patrones/P2M2FIL-EDIM1EDI/plantilla.tpl', 9, false),array('modifier', 'floor', 'patrones/P2M2FIL-EDIM1EDI/plantilla.tpl', 25, false),)), $this); ?>
...
.fil_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['fil']['index']]; ?>
  dataType=$dataType_<?php echo ((is_array($_tmp=$this->_tpl_vars['classname_maestro'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
...
"<?php else: ?>"<?php echo $this->_tpl_vars['titVal']; ?>
"<?php endif; ?> nombre="edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']]; ?>
...
.edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']]; ?>
  dataType=$dataType_<?php echo ((is_array($_tmp=$this->_tpl_vars['classname_maestro'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
...
"<?php else: ?>"<?php echo $this->_tpl_vars['titVal']; ?>
"<?php endif; ?> nombre="edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']]; ?>
" rows="3" cols=<?php if ($this->_tpl_vars['tamVal'] == ""):  echo ((is_array($_tmp=$this->_tpl_vars['lengths_maestro'][$this->_sections['edi']['index']])) ? $this->_run_mod_handler('floor', true, $_tmp) : floor($_tmp));  else:  echo $this->_tpl_vars['tamVal'];  endif; ?> editable="true" visible=<?php if ($this->_tpl_vars['visibleVal'] == '0'): ?>"false"<?php else: ?>"true"<?php endif; ?> value=$defaultData_<?php echo ((is_array($_tmp=$this->_tpl_vars['classname_maestro'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
.edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']]; ?>
  dataType=$dataType_<?php echo ((is_array($_tmp=$this->_tpl_vars['classname_maestro'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
.<?php if ($this->_tpl_vars['primaryKey_maestro'][$this->_sections['edi']['index']] == 'true'):  echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']];  else: ?>edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']];  endif; ?>}</td>
<?php elseif ($this->_tpl_vars['componente'] == 2): ?>
...
"<?php else: ?>"<?php echo $this->_tpl_vars['titVal']; ?>
"<?php endif; ?> nombre="edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']]; ?>
" size="<?php echo ((is_array($_tmp=$this->_tpl_vars['lengths_maestro'][$this->_sections['edi']['index']])) ? $this->_run_mod_handler('floor', true, $_tmp) : floor($_tmp)); ?>
" editable="true" visible=<?php if ($this->_tpl_vars['visibleVal'] == '0'): ?>"false"<?php else: ?>"true"<?php endif; ?> value=$defaultData_<?php echo ((is_array($_tmp=$this->_tpl_vars['classname_maestro'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
.edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']]; ?>
  dataType=$dataType_<?php echo ((is_array($_tmp=$this->_tpl_vars['classname_maestro'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
.<?php if ($this->_tpl_vars['primaryKey_maestro'][$this->_sections['edi']['index']] == 'true'):  echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']];  else: ?>edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']];  endif; ?>}</td>
...
<!-- ****************** PANEL DETALLE ***********************-->
	...
	{CWPanel id="ediDetalle" detalleDe="edi" tipoComprobacion="envio" action="operarBD" method="post" estado="on" claseManejadora="<?php echo ((is_array($_tmp=$this->_tpl_vars['classname_detalle'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
"}
...
"}
			{CWBotonTooltip imagen="01" titulo="Insertar registro" funcion="insertar" actuaSobre="ficha" action="<?php echo ((is_array($_tmp=$this->_tpl_vars['classname_detalle'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
__nuevo"}			
			{CWBotonTooltip imagen="02" titulo="Modificar registro" funcion="modificar" actuaSobre="ficha"}
			{CWBotonTooltip imagen="03" titulo="Eliminar registro" funcion="eliminar" actuaSobre="ficha"}										
			{CWBotonTooltip imagen="04" titulo="Restaurar valores" funcion="limpiar" actuaSobre="ficha"}
...
"<?php else: ?>"<?php echo $this->_tpl_vars['titVal']; ?>
"<?php endif; ?> nombre="edi_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['edi']['index']]; ?>
" size="<?php if ($this->_tpl_vars['tamVal'] == ""):  echo ((is_array($_tmp=$this->_tpl_vars['lengths_detalle'][$this->_sections['edi']['index']])) ? $this->_run_mod_handler('floor', true, $_tmp) : floor($_tmp));  else:  echo $this->_tpl_vars['tamVal'];  endif; ?>" editable="true" oculto="<?php echo $this->_tpl_vars['primaryKey_detalle'][$this->_sections['edi']['index']]; ?>
" <?php if ($this->_tpl_vars['fields_detalle'][$this->_sections['edi']['index']] == ($this->_tpl_vars['foreignKeyDetalle'])): ?>value=<?php if ($this->_tpl_vars['defVal'] != ''): ?>"<?php echo $this->_tpl_vars['defVal']; ?>

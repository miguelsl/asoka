<?php /* Smarty version 2.6.14, created on 2013-11-19 12:13:38
         compiled from patrones/M1EDI/action.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'patrones/M1EDI/action.tpl', 35, false),array('modifier', 'explode', 'patrones/M1EDI/action.tpl', 158, false),)), $this); ?>
<?php echo '<?php'; ?>
...
$this->_sections['select']['last']       = ($this->_sections['select']['iteration'] == $this->_sections['select']['total']);
 ...
 as \"<?php if ($this->_tpl_vars['foreignKey_detalle'] == 'true'): ?>$fields_detalle[select]<?php else: ?>edi_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['select']['index']];  endif; ?>\"<?php if ($this->_sections['select']['last']):  else: ?>, <?php endif;  endfor; endif; ?> FROM <?php echo $this->_tpl_vars['tablename_detalle']; ?>
";
...
?>
		$this->addMatching("<?php if ($this->_tpl_vars['foreignKey_detalle'][$this->_sections['edi']['index']] == 'true'):  echo $this->_tpl_vars['fields_detalle'][$this->_sections['edi']['index']];  else: ?>edi_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['edi']['index']];  endif; ?>","<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['edi']['index']]; ?>
...
$this->_sections['fecha']['last']       = ($this->_sections['fecha']['iteration'] == $this->_sections['fecha']['total']);
 $this->assign('campo', $this->_tpl_vars['fields'][$this->_sections['fecha']['index']]);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  $this->assign('calVal_edi', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['calVal']);  if ($this->_tpl_vars['types'][$this->_sections['fecha']['index']] == 'gvHidraDate'): ?>
		$fecha = new gvHidraDate(false);
<?php if ($this->_tpl_vars['calVal_edi'] == 1): ?>

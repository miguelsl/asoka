<?php /* Smarty version 2.6.14, created on 2013-11-19 12:13:38
         compiled from patrones/P2M2FIL-EDI/action.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'patrones/P2M2FIL-EDI/action.tpl', 35, false),array('modifier', 'explode', 'patrones/P2M2FIL-EDI/action.tpl', 194, false),)), $this); ?>
<?php echo '<?php'; ?>
...
$this->_sections['select']['last']       = ($this->_sections['select']['iteration'] == $this->_sections['select']['total']);
 ...
 as \"<?php if ($this->_tpl_vars['primaryKey_maestro'][$this->_sections['select']['index']] == 'true'):  echo $this->_tpl_vars['fields_maestro'][$this->_sections['select']['index']];  else: ?>edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['select']['index']];  endif; ?>\"<?php if ($this->_sections['select']['last']):  else: ?>, <?php endif;  endfor; endif; ?> FROM <?php echo $this->_tpl_vars['tablename_maestro']; ?>
";
...
?>
		$this->addMatching("<?php if ($this->_tpl_vars['primaryKey_maestro'][$this->_sections['fil']['index']] == 'true'):  echo $this->_tpl_vars['fields_maestro'][$this->_sections['fil']['index']];  else: ?>fil_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['fil']['index']];  endif; ?>","<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['fil']['index']]; ?>
...
?>
		$this->addMatching("<?php if ($this->_tpl_vars['primaryKey_maestro'][$this->_sections['edi']['index']] == 'true'):  echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']];  else: ?>edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']];  endif; ?>","<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']]; ?>
","<?php echo $this->_tpl_vars['tablename_maestro']; ?>
");
<?php endfor; endif; ?>
...
$this->_sections['fecha']['last']       = ($this->_sections['fecha']['iteration'] == $this->_sections['fecha']['total']);
 $this->assign('campo', $this->_tpl_vars['fields_maestro'][$this->_sections['fecha']['index']]);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  $this->assign('calVal_fil', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['calVal']);  $this->assign('calVal_edi', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['calVal']);  if ($this->_tpl_vars['types'][$this->_sections['fecha']['index']] == 'gvHidraDate'): ?>
...
<?php endif; ?>
		$this->addFieldType('edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['fecha']['index']]; ?>
',$fecha);
...
$this->_sections['string']['last']       = ($this->_sections['string']['iteration'] == $this->_sections['string']['total']);
 $this->assign('campo', $this->_tpl_vars['fields_maestro'][$this->_sections['string']['index']]);  $this->assign('mascara', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['maskVal']);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  if ($this->_tpl_vars['types'][$this->_sections['string']['index']] == 'gvHidraString'):  if ($this->_tpl_vars['lengths'][$this->_sections['string']['index']] == ""):  $this->assign('length', '200');  else:  $this->assign('length', $this->_tpl_vars['lengths'][$this->_sections['string']['index']]);  endif; ?>
...
<?php endif;  endif; ?>
		$this->addFieldType('edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['string']['index']]; ?>
',$string);
...
$this->_sections['int']['last']       = ($this->_sections['int']['iteration'] == $this->_sections['int']['total']);
 $this->assign('campo', $this->_tpl_vars['fields_maestro'][$this->_sections['int']['index']]);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  if ($this->_tpl_vars['types'][$this->_sections['int']['index']] == 'gvHidraInteger'): ?>
...
<?php endif; ?>
		$this->addFieldType('edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['int']['index']]; ?>
',$int);
...
<?php endif; ?>
		$this->addFieldType('edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['float']['index']]; ?>
',$float);
...
');
		...
		$check_edi = new gvHidraCheckBox('edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['components']['index']]; ?>
');
...
');
		...
		$radio_edi = new gvHidraList('edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['components']['index']]; ?>
');
...
');
		...
		$lista_edi = new gvHidraList('edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['components']['index']]; ?>
');
...
<?php $_from = $this->_tpl_vars['array_claves_detalles']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
		$this->addSlave('<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
', array('<?php echo $this->_tpl_vars['primaryKeyMaestro']; ?>
'), array('<?php echo $this->_tpl_vars['item']; ?>
'));

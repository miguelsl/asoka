<?php /* Smarty version 2.6.14, created on 2013-11-19 10:12:26
         compiled from patrones/P2M2FIL-EDIM1EDI/actionDetalle.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'patrones/P2M2FIL-EDIM1EDI/actionDetalle.tpl', 36, false),array('modifier', 'explode', 'patrones/P2M2FIL-EDIM1EDI/actionDetalle.tpl', 162, false),)), $this); ?>
<?php echo '<?php'; ?>
...
$this->_sections['select']['last']       = ($this->_sections['select']['iteration'] == $this->_sections['select']['total']);
 ...
 as \"edi_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['select']['index']]; ?>
...
?>
		$this->addMatching("edi_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['edi']['index']]; ?>
","<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['edi']['index']]; ?>
...
$this->_sections['fecha']['last']       = ($this->_sections['fecha']['iteration'] == $this->_sections['fecha']['total']);
 $this->assign('campo', $this->_tpl_vars['fields_detalle'][$this->_sections['fecha']['index']]);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  $this->assign('calVal_edi', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['calVal']);  if ($this->_tpl_vars['types_detalle'][$this->_sections['fecha']['index']] == 'gvHidraDate'): ?>
...
<?php endif;  if ($this->_tpl_vars['componente'] == 4): ?>
		$lista_edi = new gvHidraList('edi_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['components']['index']]; ?>
');

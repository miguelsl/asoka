<?php /* Smarty version 2.6.14, created on 2013-11-19 10:12:26
         compiled from patrones/P2M2FIL-EDIM1EDI/actionMaestro.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'patrones/P2M2FIL-EDIM1EDI/actionMaestro.tpl', 35, false),array('modifier', 'explode', 'patrones/P2M2FIL-EDIM1EDI/actionMaestro.tpl', 194, false),)), $this); ?>
<?php echo '<?php'; ?>
...
$this->_sections['select']['last']       = ($this->_sections['select']['iteration'] == $this->_sections['select']['total']);
 ...
 as \"edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['select']['index']]; ?>
...
?>
		$this->addMatching("edi_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']]; ?>
","<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['edi']['index']]; ?>
","<?php echo $this->_tpl_vars['tablename_maestro']; ?>
");
<?php endfor; endif; ?>
...
?>'edi_<?php echo $this->_tpl_vars['primaryKeyMaestroArray'][$this->_sections['pk_maestro']['index']]; ?>
...
?>'edi_<?php echo $this->_tpl_vars['foreignKeyDetalleArray'][$this->_sections['fk_detalle']['index']]; ?>
',<?php endfor; endif; ?>));

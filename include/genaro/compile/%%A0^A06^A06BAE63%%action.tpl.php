<?php /* Smarty version 2.6.14, created on 2013-11-13 08:42:40
         compiled from patrones/P2M2FIL-LIS/action.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'patrones/P2M2FIL-LIS/action.tpl', 35, false),array('modifier', 'explode', 'patrones/P2M2FIL-LIS/action.tpl', 199, false),)), $this); ?>
<?php echo '<?php'; ?>
...
$this->_sections['select']['last']       = ($this->_sections['select']['iteration'] == $this->_sections['select']['total']);
 ...
 as \"<?php if ($this->_tpl_vars['primaryKey_maestro'][$this->_sections['select']['index']] == 'true'):  echo $this->_tpl_vars['fields_maestro'][$this->_sections['select']['index']];  else: ?>lis_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['select']['index']];  endif; ?>\"<?php if ($this->_sections['select']['last']):  else: ?>, <?php endif;  endfor; endif; ?> FROM <?php echo $this->_tpl_vars['tablename_maestro']; ?>
";
...
$this->_sections['fil']['last']       = ($this->_sections['fil']['iteration'] == $this->_sections['fil']['total']);
 if ($this->_tpl_vars['primaryKey_maestro'][$this->_sections['fil']['index']] != 'true'): ?>
...
?>
		$this->addMatching("<?php if ($this->_tpl_vars['primaryKey_maestro'][$this->_sections['lis']['index']] == 'true'):  echo $this->_tpl_vars['fields_maestro'][$this->_sections['lis']['index']];  else: ?>lis_<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['lis']['index']];  endif; ?>","<?php echo $this->_tpl_vars['fields_maestro'][$this->_sections['lis']['index']]; ?>
","<?php echo $this->_tpl_vars['tablename_maestro']; ?>
");
<?php endfor; endif; ?>

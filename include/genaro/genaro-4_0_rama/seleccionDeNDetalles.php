...
if($numeroDeDetalles <= 0) {
	...
	if (PEAR::isError($mdb))
	{
		print_r("<b>ERROR:</b> Se ha producido un error al intentar establecer la conexión con el SGBD. Revise el fichero gvHidraConfig.inc.xml de la aplicación. El texto del error es:\n<br/>");
		die($mdb->getUserInfo());
	}

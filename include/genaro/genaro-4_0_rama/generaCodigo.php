...
$argumentos = $_POST;
$nombreModulo = ucwords($argumentos['nombreModulo']);
...
if (PEAR::isError($mdb))
{
	print_r("<b>ERROR:</b> Se ha producido un error al intentar establecer la conexiï¿½n con el SGBD. Revise el fichero gvHidraConfig.inc.xml de la aplicaci&oacute;n. El texto del error es:\n<br/>");
	die($mdb->getUserInfo());
}
...
QUERY;
	...
	if($dsn['phptype']=='oci8' or $dsn['phptype']=='oracle') {
		...
		$dt->set_db_field_types($tipoCampoTabla);
	}	
	else {

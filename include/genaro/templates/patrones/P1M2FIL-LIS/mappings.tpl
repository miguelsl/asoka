			...
			$this->_AddForward('<<$classname|capitalize>>__buscar', 'gvHidraNoData', 'index.php?view=views/<<$nombreModulo|capitalize>>/p_<<$classname_maestro|capitalize>>.php&panel=listar');

...
class Tasoka_razas extends gvHidraForm_DB
{
	public function __construct() {
		...
		$nombreTablas= array('tasoka_raza');
		parent::__construct($g_dsn, $nombreTablas);

		/************************ QUERYs ************************/
		
		//Consulta del modo de trabajo LIS
		$str_select = "SELECT tipo_animal as \"lis_tipo_animal\", nombre as \"lis_nombre\" FROM tasoka_raza";
		...
		//Modo de trabajo FIL
		$this->addMatching("fil_tipo_animal","tipo_animal","tasoka_raza");
		$this->addMatching("fil_nombre","nombre","tasoka_raza");

		//Modo de trabajo LIS
		$this->addMatching("lis_tipo_animal","tipo_animal","tasoka_raza");
		$this->addMatching("lis_nombre","nombre","tasoka_raza");
		...
		*/
        ...
        $lista_especies = new gvHidraList('fil_tipo_animal','ESPECIES');
		$lista_especies->addOption('','Cualquiera...');
		$lista_especies->setSelected('');
		$this->addList($lista_especies);
		
		$lista_especies = new gvHidraList('lis_tipo_animal','ESPECIES');
		$lista_especies->addOption('','Cualquiera...');
		$lista_especies->setSelected('');
		$this->addList($lista_especies);
		/************************ END COMPONENTS ************************/						

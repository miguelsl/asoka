...
/**
* Clase Manejadora Tasoka_bacteria
* 
...
class Tasoka_bacteria extends gvHidraForm_DB
{
	public function __construct() {
		...
		$nombreTablas= array('tasoka_bacteria');
		parent::__construct($g_dsn, $nombreTablas);

		/************************ QUERYs ************************/
		
		//Consulta del modo de trabajo LIS
		$str_select = "SELECT id as \"lis_id\", tipo_animal as \"lis_tipo_animal\", nombre as \"lis_nombre\" FROM tasoka_bacteria";
		...
		//Modo de trabajo FIL
	//	$this->addMatching("fil_id","id","tasoka_bacteria");
		$this->addMatching("fil_tipo_animal","tipo_animal","tasoka_bacteria");
		$this->addMatching("fil_nombre","nombre","tasoka_bacteria");

		//Modo de trabajo LIS
		$this->addMatching("lis_id","id","tasoka_bacteria");
		$this->addMatching("lis_tipo_animal","tipo_animal","tasoka_bacteria");
		$this->addMatching("lis_nombre","nombre","tasoka_bacteria");
	...
	*/		
	public function preInsertar($objDatos) {
		$id=$this->calcularSecuencia('tasoka_bacteria','id',array(),1);

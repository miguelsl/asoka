...
/**
* Clase Manejadora Tasoka_saludM
* 
...
class Tasoka_saludM extends gvHidraForm_DB
{
	public function __construct() {
		...
		*/
		...
		//Relacionamos con las clases detalle
				$this->addSlave('Tasoka_salud_analiticaD', array('id'), array('id_animal'));
				$this->addSlave('Tasoka_salud_vacunaD', array('id'), array('id_animal'));
				$this->addSlave('Tasoka_salud_desaparasitacionD', array('id'), array('id_animal'));

...
*/
class Tasoka_salud_analiticaD extends gvHidraForm_DB
{
	public function __construct() {
		...
		$str_select = "SELECT id_animal as \"id_animal\", fecha as \"edi_fecha\",nombre_fichero as \"edi_nombre_fichero\",informe as \"edi_informe\"  FROM tasoka_historial_analitica";		 
		$this->setSelectForSearchQuery($str_select);
	...
	*/	
	public function postRecargar($objDatos) {
	    ...
	    if($m_datos[$key]['edi_informe']!=null) {
               ...
               // $objDatos->setOperation("seleccionar");
                ...
                if(is_array($res)&&$res[0]['informe']!=''){                    
                  ...
                  //Para que no continue la ejecuci\F3n de la p\E1gina
                    ...
                    $actionForward->put('IGEPclaseManejadora','Tasoka_salud_analiticaD');

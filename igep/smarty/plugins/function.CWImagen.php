...
//die;				
	...
	{	
		...
		$compotxt .= "<a href='$src' class='bump_$id' style='outline:none;' rel='".$wBump."-".$hBump."'>".$img."</a>";
		$compotxt .= "<script type='text/javascript'>\n";
		$compotxt .= "window.addEvent('domready',function() {\n";
		$compotxt .= "doBump( '.bump_$id', ";
			// ruta al custom
			$compotxt .= "'".PATH_CUSTOM."', ";
			// inSpeed, outSpeed (ms)
			$compotxt .= "600, 500, ";	
			// effectsIn 
			$compotxt .= "Fx.Transitions.Bounce.EaseOut, ";
			// effectsOut
			$compotxt .= "Fx.Transitions.Bounce.EaseOut )";
		$compotxt .= "})\n ";
		$compotxt .= "</script>\n";		

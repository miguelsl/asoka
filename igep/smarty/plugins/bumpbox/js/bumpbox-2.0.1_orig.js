...
function doBump(names, inSpeed, outSpeed, boxColor, backColor, bgOpacity, bRadius, borderWeight, borderColor, boxShadowSize, boxShadowColor, iconSet, effectsIn, effectsOut, bgImage, bgPosition, bgRepeat) {
    ...
    if (!bgImage) {
        bgImage = 'bumpbox/images/ajax-loader.gif';
    }
    var iconPath = 'bumpbox/iconsets/' + iconSet + '/';
        ...
        var eff = new Fx.Morph($('grow'), {
            ...
            onComplete: function () {
                ...
                if (content.indexOf(".jpg") != -1 || content.indexOf(".gif") != -1 || content.indexOf(".png") != -1) {
                    ...
                    div.inject(el);
                    var f = flowplayer(div, "bumpbox/flowplayer/flowplayer.swf", {
                        plugins: {
                            viral: {
                                url: 'bumpbox/flowplayer/flowplayer.viralvideos-3.2.3.swf',
                                embed: {
                    ...
                    div.inject(el);
                    f = flowplayer(div, "bumpbox/flowplayer/flowplayer.swf", {
                        buffering: true,
                        autoplay: true,
                        clip: content,
                        wmode: 'transparent',
                        plugins: {
                            ...
                            myContent: {
                                url: 'bumpbox/flowplayer/flowplayer.audio.swf',
                                bottom: 0,
                                width: maxw - 20,
                                left: 0,
                                borderRadius: 10,

...
function smarty_block_CWContenedor($params, $content, &$smarty) 
{
	...
	{	
		...
		$ini_contenedor .= "<tr class='text'>\n";	
		$ini_contenedor .= "<td align='center'>\n";
		/*$ini_contenedor .= "<table style='width: 100%; border-style:solid;' cellpadding='2' cellspacing='0'>\n";*/
		$ini_contenedor .= "<table class=\"".$estiloPanel."\">\n";
		$ini_contenedor .= "<tr class='text'>\n";
		$ini_contenedor .= "<td style='vertical-align:top;' >\n";
		
		$fin_contenedor = "</td>\n";
		$fin_contenedor .= "</tr>\n";
		$fin_contenedor .= "</table>\n";
		$fin_contenedor .= "</td>\n";
		$fin_contenedor .= "</tr>\n";	

...
function smarty_block_CWArbol($params, $content, &$smarty) {
	...
	{		
		...
		$html_arbol .= "<td id='celdaArbol' class='tree' style='width: ".$anchoArbol."%;' >\n";
	
			$html_arbol .= "<div id='divArbolCab' style='display:block; max-height: ". $alturaMaxArbol ."px;'>\n";
				$html_arbol .= "<div class='barTopPanel'>";
					$html_arbol .= "<table style='width: 100%;' cellspacing='0' cellpadding='1'>\n";
					$html_arbol .= "<tr>\n";
			    	$html_arbol .= "<td class='titlePanel'>".$tituloArbol."</td>\n";
			...
			$html_arbol .= "<div id='divArbolOculto' style='display:none;width:auto; max-height: ". $alturaMaxArbol ."px;'>\n";
				$html_arbol .= "<div class='barTopPanel'>";
					$html_arbol .= "<table style='width: 100%;' cellspacing='0' cellpadding='1'>\n";
					$html_arbol .= "<tr>\n";
			    	$html_arbol .= "<td class='titlePanel'>".$tituloArbol."</td>\n";
			...
			$html_arbol .= "<div id='divArbol' style='display:block;max-height: ". $alturaMaxArbol ."px;overflow:auto;'>\n"; // MOD(ENLAZA): Poder definir la altura del árbol

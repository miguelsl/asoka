...
if (is_null($valorFecha))
 ...
 $htmlResult.= '</title>'; 
 if (!empty($custom))
 	$htmlResult.= "<link rel='stylesheet' href='custom/$custom/css/aplicacion.css' type='text/css' />";
 $htmlResult.= '</head>'; 
 ...
 $htmlResult.= '<div id="debugger">';
 $htmlResult.= '<div id="titleDebugger">Criterios de filtrado</div>';
 $htmlResult.= '<div class="tabularLineHead">&nbsp;</div>';
 $htmlResult.= '<div id="panelDebugger">'; 
 $htmlResult.= '<div id="aplDebugger">Aplicación: <input class="edit" size="12" type="text" name="db_aplicacion" id="db_aplicacion" value="'.$valorAplicacion.'"/></div>';
 $htmlResult.= '<div id="userDebugger">Usuario: <input class="edit" size="12" type="text" name="db_usuario" id="db_usuario" value="'.$valorUsuario.'"/></div>';
 $htmlResult.= '<div id="refreshDebugger">';
 ...
 $htmlResult.= '<table class="paramsDebugger">';
/* $htmlResult.= '<tr>';
...
/* $htmlResult.= '<td>';
 ...
 //$htmlResult.= '<div class="tabularLineHead">&nbsp;</div>';
 $htmlResult.= '<br>';
 $htmlResult.= '<div id="titleDebugger">Traza de ejecución</div>';
 $htmlResult.= '<div class="tabularLineHead">&nbsp;</div>';
 $htmlResult.= '<table class="resultDebugger">';
 $htmlResult.= '<tr>';

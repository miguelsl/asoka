    ...
    public function perform($actionMapping, $actionForm) {						
        ...
        switch ($str_accion) {
            case 'abrirAplicacion':
				...
				switch($navegador)
				{
					case (strpos($navegador,'Firefox')!==false):
					case (strpos($navegador,'Chrome')!==false):
						$compatible = true;
					break;
					case (strpos($navegador,'MSIE')!==false):
					case (strpos($navegador,'Safari')!==false):
					case (strpos($navegador,'Opera')!==false):
						$compatible = false;
					break;
					default:
						$compatible = false;

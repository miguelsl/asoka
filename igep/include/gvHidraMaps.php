...
* @version	$Id: gvHidraMaps.php,v 1.23 2010-11-17 16:36:07 afelixf Exp $
...
class gvHidraMaps extends MappingManager {
    ...
    */
    function gvHidraMaps () {
	    ...
	    $this->_AddForward('cambiarPanelDetalle', 'IgepOperacionOculto', 'index.php?view=igep/views/igep_ordenarTabla.php');

...
{	
	...
	*/				
	static function session_start($app=null, $start=true)
	{
		if (empty($app))
  ...
  */    		
	...
	*/																				
	...
	/**
	* Borra el valor de una variable ubicada en la zona global de la SESSION.   
	*
	* @access	public	 
	* @param	string	$nomVariable	 
	* @return	any
	*/																				
	static function borraVariableGlobal($nomVariable)
	{

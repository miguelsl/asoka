 ...
 * Está estructurada como un patrón SINGLETON con persistencia funcional en SESION.
 * 
 * @package gvHIDRA
 */
...
class ConfigFramework
{
	...
	*/
	public static function getCustomDirName()
	{
		...
		{			
			...
			throw new Exception('getCustomDirName: no está definido el custom a usar');
		}			
	...
	*/
	public function getAppVersion()
	{
		if(empty(self::$_instance))
		{
			...
			if (!empty($appVersion))
					return($appVersion);
			throw new Exception('getAppVersion: no está definido el codigo de la aplicación');			
		}			
	...
	*/
	 ...
	 * Este método permite accder a dicho valor
	...
	*/
	 ...
	 * 
	 *  Carga el fichero de configuración XML indicado por parámetro y asigna los valores
	 * leídos en el mismo en la instancia.del objeto
	 * @access private

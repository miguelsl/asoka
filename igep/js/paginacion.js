...
function  f_oPaginacion_set(sufijo,nom_capa_enlaces,pagina_inicial,paginas_totales,pagInsertar,pagExactas,tam_marco, textoEnlaces,formulario,esMaestro,numRegistros,actionForm,rutaImg)
{
...
{		
	...
	if (this.pagina_activa < 9) //Si no hay 10 páginas por detrás
		...
		enlace_antdiez = '<img src="'+this.rutaImg+'paginacion/10anterior.gif" class="buttonPag" title="Retroceder 10 páginas" alt="&lt;&lt;" />&nbsp;';
	else //Hay 10 páginas por detrás
	{
		...
		enlace_antdiez += '<img src="'+this.rutaImg+'paginacion/anterior10.gif" class="buttonPag" title="Retroceder 10 páginas" alt="&lt;&lt;" /></a>&nbsp;';
	} //Página activa menor que 0
		
	//Diez siguientes
	if (this.pagina_activa > (pagsATratar - 10))
		enlace_sigdiez = '<img src="'+this.rutaImg+'paginacion/10siguiente.gif" class="buttonPag" title="Avanzar 10 páginas" alt="&gt;&gt;" />&nbsp;&nbsp;';
	else 
	{
		...
		enlace_sigdiez += '<img src="'+this.rutaImg+'paginacion/siguiente10.gif" class="buttonPag" title="Avanzar 10 páginas" alt="&gt;&gt;" /></a>&nbsp;';
	}
		
	//Enlace anterior
	if (this.pagina_activa == 0)
		enlace_ant = '<img src="'+this.rutaImg+'paginacion/anterior.gif" class="buttonPag" title="Página actual" alt="·" />&nbsp;';
	else 
	{
		enlace_ant = this.cadenaEnlaces(this.pagina_activa-1);
		enlace_ant += '<img src="'+this.rutaImg+'paginacion/anterior2.gif" class="buttonPag" title="Página anterior" alt="&lt;" /></a>&nbsp;';
	}	
		
	//Enlace siguiente
	if (this.pagina_activa >= (pagsATratar - 1)) 
		enlace_sig = '<img src="'+this.rutaImg+'paginacion/siguiente.gif" class="buttonPag" title="Página siguiente" alt="&gt;" />&nbsp;';
	else 
	{	
		enlace_sig = this.cadenaEnlaces(this.pagina_activa+1);
		enlace_sig += '<img src="'+this.rutaImg+'paginacion/siguiente2.gif" class="buttonPag" title="Página siguiente" alt="&gt;" /></a>&nbsp;';
	}
	...
	if (this.pagina_activa == pri) 
		principio = '<img src="'+this.rutaImg+'paginacion/principio.gif" class="buttonPag" title="Primera página" alt="|&lt;" />&nbsp;';
	else 
	{
		principio = this.cadenaEnlaces(0);
		principio += '<img src="'+this.rutaImg+'paginacion/principio2.gif" class="buttonPag" title="Primera página" alt="|&lt;" /></a>&nbsp;';
	}	
	if (this.pagina_activa == ult) 
		ultima = '<img src="'+this.rutaImg+'paginacion/final.gif" class="buttonPag" title="Última página" alt="&gt|;" />&nbsp;';
	else 
	{
		ultima = this.cadenaEnlaces(this.paginas_totales-1);
		ultima += '<img src="'+this.rutaImg+'paginacion/final2.gif" class="buttonPag" title="Última página" alt="&gt|;" /></a>&nbsp;';
	}
	...
	selecPag = "&nbsp;&nbsp;Ir a pág. <input class='text edit goToPage' type='text' id='pag' size='2' ";
	selecPag = selecPag + "onkeypress='javascript:if (isNaN(this.value)) this.value = \"\"'; onChange='javascript:"+toPage+"'>";
	
	enlacesHTML = txtNumRegTabular + enlace_ref + principio + enlace_antdiez + enlace_ant + enlaces + enlace_sig + enlace_sigdiez + ultima;
	enlacesHTML = enlacesHTML + selecPag;
